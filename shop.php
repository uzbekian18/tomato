					    ...
					    <ul class="nav navbar-nav">
					        ...
					        <li class="dropdown active">
					        	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Shop</a>
					          	<ul class="dropdown-menu sub-menu">
						            <li class="active-child-menu"><a href="shop.php"><i class="fa fa-angle-double-right"></i>Shop page</a></li>
	...
	<div class="shop-page">
		<div class="container">
			<div class="row">
					...
					<div class="catagorys">
						<div class="catagory-item">
							<select>
								...
								<option>Breads & Rolls</option>
								<option>Beverages</option>
								<option>Cookies & Candy</option>
				...
				<div class="grid food-menu-item-wrapper">
					<div class="element-item food-item style-2 breakfast drinks col-md-3 col-sm-4">
					...
					<div class="element-item food-item style-2 lunch col-md-3 col-sm-4">
						<div class="food-item-img">
							<img src="assets/images/food-menu/lunch9.jpg" alt="">
							<div class="food-item-img-overlay"></div>
							<div class="food-item-img-overlay-content">
								<a href="#" class="button">add to cart</a>
							</div>
					...
					<div class="element-item food-item style-2 lunch col-md-3 col-sm-4">
						<div class="food-item-img">
							<img src="assets/images/food-menu/lunch11.jpg" alt="">
							<div class="food-item-img-overlay"></div>
							<div class="food-item-img-overlay-content">
								<a href="#" class="button">add to cart</a>
							</div>
					...
					<div class="element-item food-item style-2 lunch col-md-3 col-sm-4">
						<div class="food-item-img">
							<img src="assets/images/food-menu/lunch12.jpg" alt="">
							<div class="food-item-img-overlay"></div>
							<div class="food-item-img-overlay-content">
								<a href="#" class="button">add to cart</a>
							</div>
					...
					<div class="element-item lunch food-item style-2 col-md-3 col-sm-4">
						<div class="food-item-img">
					...
					<div class="element-item food-item style-2 dinner col-md-3 col-sm-4">
						<div class="food-item-img">
