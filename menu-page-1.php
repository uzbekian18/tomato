					    ...
					    <ul class="nav navbar-nav">
					        ...
					        <li class="dropdown active">
					        	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Menu</a>
					          	<ul class="dropdown-menu sub-menu">
						            <li  class="active-child-menu"><a href="menu-page-1.php"><i class="fa fa-angle-double-right"></i>Menu page one</a></li>
			...
			<div class="row">
				...
				<div class="food-menu-item-wrapper">
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/breakfast8.jpg" alt=""></a>
							</div>
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/breakfast5.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/breakfast7.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/breakfast10.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/breakfast6.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
			...
			<div class="row">
				...
				<div class="food-menu-item-wrapper">
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/dinner8.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/dinner5.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/dinner6.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/dinner9.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/dinner10.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/dinner7.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
					...
					<div class="col-md-4 col-sm-6">
						<div class="food-item">
							<div class="food-item-img">
								<a href="#"><img src="assets/images/food-menu/dinner11.jpg" alt=""></a>
							</div>
							<div class="food-item-details">
								<div class="dotted-title">
									<div class="dotted-name">
